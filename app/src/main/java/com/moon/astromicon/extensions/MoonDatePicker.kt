    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TextWheelViewHolder {
        val view =
            LayoutInflater.from(parent.context)
                .inflate(R.layout.moon_picker_year_list_item, parent, false) as TextView
...
class MoonPickerView @JvmOverloads constructor(
    context: Context,
    ...
    override val adapters: Triple<RecyclerView.Adapter<*>,
